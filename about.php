			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						...
						<h4>Little Story</h4>
						<p> Welcome to the paradise of foodies. </p>
				...
				<div class="col-lg-6 col-md-6">
					<img src="images/images.png" style="height: 400px; width: 100%" class="img-fluid">
				</div>
				<div class="col-md-12">
					<div class="inner-pt">
						<p> The best place to stay and spend your time over here seeing the view of lake.

 </p>
						<p>Spend your time with ur loved ones
 </p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Special Menu</h2>
						<p>Here we offer gujarati dish for everyone</p>
					</div>
				</div>
			</div>
